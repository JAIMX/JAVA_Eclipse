...
//		System.out.println("Graph transfer done!");
		...
		double[] initialY=new double[data.numOfx];
		
		
		
		
		Bender_Decomposition test=new Bender_Decomposition(data.c, data.f, data.bb, data.A, data.B, initialY,0);
