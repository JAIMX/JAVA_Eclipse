...
public class DPtsp_bit {
    ...
    public DPtsp_bit(double distances[][]) {
...
//        double[][] dic={{100,1,4},{1,100,2},{4,2,100}};
        ...
        Scanner in= new Scanner(Paths.get("D:/workspace/mTSP/data/tsp17.txt"));
        int n=in.nextInt();
        ...
        DPtsp_bit test=new DPtsp_bit(dist);
